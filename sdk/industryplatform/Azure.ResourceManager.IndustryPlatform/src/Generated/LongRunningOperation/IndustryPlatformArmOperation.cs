...
#pragma warning disable SA1649 // File name should match first type name
    internal class IndustryPlatformArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal IndustryPlatformArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal IndustryPlatformArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "IndustryPlatformArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
