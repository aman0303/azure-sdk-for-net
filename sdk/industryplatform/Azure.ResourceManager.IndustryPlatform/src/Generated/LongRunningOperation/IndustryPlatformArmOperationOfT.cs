...
#pragma warning disable SA1649 // File name should match first type name
    internal class IndustryPlatformArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of IndustryPlatformArmOperation for mocking. </summary>
        protected IndustryPlatformArmOperation()
        {
        }

        internal IndustryPlatformArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal IndustryPlatformArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "IndustryPlatformArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
