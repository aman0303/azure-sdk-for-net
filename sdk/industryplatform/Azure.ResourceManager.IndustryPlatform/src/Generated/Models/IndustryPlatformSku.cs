...
namespace Azure.ResourceManager.IndustryPlatform.Models
{
    ...
    public partial class IndustryPlatformSku
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="IndustryPlatformSku"/>. </summary>
        ...
        internal IndustryPlatformSku(string name, IndustryPlatformSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
        ...
        /// <summary> Initializes a new instance of <see cref="IndustryPlatformSku"/> for deserialization. </summary>
        internal IndustryPlatformSku()
        {
        }
        ...
        public IndustryPlatformSkuTier? Tier { get; set; }
